...
def initialize(window):
    ...
    window.questionLayout.addWidget(questionEdit)
    window.questionLayout.addWidget(questionDisplay)
    ...
    window.option = qtw.QButtonGroup()
    ASelect = qtw.QRadioButton()
    BSelect = qtw.QRadioButton()
    CSelect = qtw.QRadioButton()
    DSelect = qtw.QRadioButton()
    window.option.addButton(ASelect, 0)
    window.option.addButton(BSelect, 1)
    window.option.addButton(CSelect, 2)
    window.option.addButton(DSelect, 3)
    ALayout.addWidget(ASelect)
    BLayout.addWidget(BSelect)
    CLayout.addWidget(CSelect)
    DLayout.addWidget(DSelect)
    ...
    window.optionALayout.addWidget(optionAEdit)
    window.optionALayout.addWidget(optionADisplay)
    window.optionBLayout.addWidget(optionBEdit)
    window.optionBLayout.addWidget(optionBDisplay)
    window.optionCLayout.addWidget(optionCEdit)
    window.optionCLayout.addWidget(optionCDisplay)
    window.optionDLayout.addWidget(optionDEdit)
    window.optionDLayout.addWidget(optionDDisplay)
