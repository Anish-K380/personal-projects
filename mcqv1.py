...
def initialize(window):
    ...
    testLayout = qtw.QVBoxLayout()
    testWidget.setLayout(testLayout)
    questionLayout_ = qtw.QHBoxLayout()
    window.questionNumber = qtw.QLabel('')
    window.questionLayout = qtw.QStackedLayout()
    window.questionEdit = qtw.QTextEdit()
    window.questionEdit.setMinimumWidth(700)
    window.questionEdit.setMinimumHeight(100)
    window.questionDisplay = qtw.QLabel('')
    window.questionLayout.addWidget(window.questionEdit)
    window.questionLayout.addWidget(window.questionDisplay)
    questionLayout_.addWidget(window.questionNumber)
    questionLayout_.addLayout(window.questionLayout)
    questionLayout_.addStretch(1)
    ALayout = qtw.QHBoxLayout()
    BLayout = qtw.QHBoxLayout()
    CLayout = qtw.QHBoxLayout()
    DLayout = qtw.QHBoxLayout()
    window.option = qtw.QButtonGroup()                  #test page
    window.ASelect = qtw.QRadioButton()
    window.BSelect = qtw.QRadioButton()
    window.CSelect = qtw.QRadioButton()
    window.DSelect = qtw.QRadioButton()
    window.option.addButton(window.ASelect, 0)
    window.option.addButton(window.BSelect, 1)
    window.option.addButton(window.CSelect, 2)
    window.option.addButton(window.DSelect, 3)
    ALayout.addWidget(window.ASelect)
    BLayout.addWidget(window.BSelect)
    CLayout.addWidget(window.CSelect)
    DLayout.addWidget(window.DSelect)
    ALayout.addWidget(qtw.QLabel('A)'))
    BLayout.addWidget(qtw.QLabel('B)'))
    CLayout.addWidget(qtw.QLabel('C)'))
    DLayout.addWidget(qtw.QLabel('D)'))
    window.optionALayout = qtw.QStackedLayout()
    window.optionBLayout = qtw.QStackedLayout()
    window.optionCLayout = qtw.QStackedLayout()
    window.optionDLayout = qtw.QStackedLayout()
    window.optionAEdit = qtw.QTextEdit()
    window.optionBEdit = qtw.QTextEdit()
    window.optionCEdit = qtw.QTextEdit()
    window.optionDEdit = qtw.QTextEdit()
    window.optionAEdit.setMinimumWidth(450)
    window.optionBEdit.setMinimumWidth(450)
    window.optionCEdit.setMinimumWidth(450)
    window.optionDEdit.setMinimumWidth(450)
    window.optionAEdit.setMinimumHeight(50)
    window.optionBEdit.setMinimumHeight(50)
    window.optionCEdit.setMinimumHeight(50)
    window.optionDEdit.setMinimumHeight(50)
    window.optionADisplay = qtw.QLabel('')
    window.optionBDisplay = qtw.QLabel('')
    window.optionCDisplay = qtw.QLabel('')
    window.optionDDisplay = qtw.QLabel('')
    window.optionALayout.addWidget(window.optionAEdit)
    window.optionALayout.addWidget(window.optionADisplay)
    window.optionBLayout.addWidget(window.optionBEdit)
    window.optionBLayout.addWidget(window.optionBDisplay)
    window.optionCLayout.addWidget(window.optionCEdit)
    window.optionCLayout.addWidget(window.optionCDisplay)
    window.optionDLayout.addWidget(window.optionDEdit)
    window.optionDLayout.addWidget(window.optionDDisplay)
    ALayout.addLayout(window.optionALayout)
    BLayout.addLayout(window.optionBLayout)
    CLayout.addLayout(window.optionCLayout)
    DLayout.addLayout(window.optionDLayout)
    ALayout.addStretch(1)
    BLayout.addStretch(1)
    CLayout.addStretch(1)
    DLayout.addStretch(1)
    testLayout.addStretch(4)
    testLayout.addLayout(questionLayout_)
    testLayout.addStretch(2)
    testLayout.addLayout(ALayout)
    testLayout.addStretch(1)
    testLayout.addLayout(BLayout)
    testLayout.addStretch(1)
    testLayout.addLayout(CLayout)
    testLayout.addStretch(1)
    testLayout.addLayout(DLayout)
    testLayout.addStretch(7)
